...
public class UserAddDAO {
	...
	public UserAddDAO(Connection conn) {
		this.conn = conn;
	}
	...
	{	
		...
		try {
			String sql = "insert into punchprodatabase.users (employee_first_name, employee_last_name, employee_contact_number, username, employee_job_description) values (?, ?, ?, ?, ?)";
